...
2. Run `npm i @capacitor-community/electron` in your Electron project's directory. This will install the platform for use with the `@capacitor/cli`.
3. Run `npx cap add @capacitor-community/electron` to initiate the platform, this will create the `electron` folder in your project.
